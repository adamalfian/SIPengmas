					...
					<form action="insert.php" method="post">
						<div class="row form-group">
							<div class="col-md-6">
								...
								<input type="text" id="Nama" class="form-control mb" placeholder="Nama" name="nama_users">
							</div>

							<div class="col-md-6">
								<label for="kelamin">Jenis Kelamin</label>
								<select class="form-control" name="jk_users" required/>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="Telp" class="form-control" placeholder="Nomor Telepon Aktif" name="nohp_users">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="Alamat" class="form-control" placeholder="Alamat Saat Ini" name="alamat_users">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="Angkatan" class="form-control" placeholder="Tahun Masuk" name="angkatan_users">
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-12">
								<label for="Alamat">Username</label>
								<input type="text" id="Angkatan" class="form-control" placeholder="Username" name="username_users">
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-12">
								<label for="Alamat">Password</label>
								<input type="text" id="Angkatan" class="form-control" placeholder="Password" name="password_users">
							</div>
						</div>
