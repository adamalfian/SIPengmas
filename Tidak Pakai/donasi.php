			...
			<div class="gtco-container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 gtco-heading text-center">
						<h2>Donasi</h2>
						<p>HMTC selalu bersimpati terhadap peristiwa bencana atau hal-hal yang tidak diinginkan</p>
					</div>
				</div>
				<div class="row">
						...
						<div class="owl-carousel owl-carousel-carousel">
							<div class="item">
								<div class="gtco-staff">
									...
									<h2>Santunan Keluarga Korban Bom Teroris</h2>
									<p class="role">Surabaya</p>
									<p>Mereka kahilangan anggota keluarga yang dicintai nya.</p>
							...
							<div class="item">
								<div class="gtco-staff">
									...
									<h2>Menolong Yang Tidak Mampu</h2>
									<p class="role">Surabaya</p>
									<p>Buat sedih mereka berhenti saat ini juga</p>
