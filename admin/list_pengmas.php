                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div>
                                                <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal2">Tambah Pengmas</button>
                                            </div>
                                            <!-- Modal -->
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="list_pengmas.php" method="post">
                                            ...
                                            //include('connect.php');
                                                        ...
                                                        if (mysqli_num_rows($sql) > 0) {
                                                            ...
                                                            while ($data = mysqli_fetch_assoc($sql)) {
                                                                ...
                                                                <td><button class="btn btn-danger btn-xs"> <a href="delete.php?id='.$data['id_pengmas'].'" style="color: #fff; text-decoration: none;"> Hapus</button> </td>
                                                                </tr>
                                                                ';
                                                                ++$no;
                                                            }
