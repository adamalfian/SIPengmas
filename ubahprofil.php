					...
					<form action="#">
						<div class="row form-group">
							<div class="col-md-6">
								...
								<input type="text" id="Nama" class="form-control mb" placeholder="Glenn Lucas">
							</div>

							<div class="col-md-6">
								<label for="kelamin">Jenis Kelamin</label>
								<input type="text" id="kelamin" class="form-control" placeholder="Laki-Laki">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="Telp" class="form-control" placeholder="08573456789">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="Alamat" class="form-control" placeholder="Jakarta" >
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-6">
								...
								<input type="text" id="Angkatan" class="form-control" placeholder="2015">
							</div>
						</div>

						<div class="row form-group">
							<div class="col-md-6">
								<label for="Alamat">Isi Saldo Uang Virtual</label>
								<input type="text" id="Angkatan" class="form-control" placeholder="0">
							</div>
						</div>

						<h4>Perhatian : pengisian uang virtual menunggu persetujuan admin</h4>
						<br>
						<br>


						<div class="form-group text-center">
							<a href="halo.html"><input type="submit" value="Ubah" class="btn btn-primary"></a>
						</div>
